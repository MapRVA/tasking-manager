...
// API ENDPOINTS
export const API_VERSION = getEnvVar('REACT_APP_APP_API_VERSION', 'v2');
export const API_URL =
  getEnvVar('REACT_APP_APP_API_URL', 'http://127.0.0.1:5000') + '/api/' + API_VERSION + '/';
...
export const INTERMEDIATE_LEVEL_COUNT = Number(
  getEnvVar('REACT_APP_MAPPER_LEVEL_INTERMEDIATE', '250'),
);
export const ADVANCED_LEVEL_COUNT = Number(getEnvVar('REACT_APP_MAPPER_LEVEL_ADVANCED', '500'));
...
export const OSM_CLIENT_ID = getEnvVar('REACT_APP_CLIENT_ID', '');
export const OSM_REDIRECT_URI = getEnvVar('REACT_APP_REDIRECT_URI', '');
